...
int main(int argc, char *argv[])
{
    ...
    fprintf(client_time_log, "Total %d gets performed in %ld microseconds\n", n_gets, get_processing_time.tv_usec);
    fprintf(client_time_log, "Total %d sets performed in %ld microseconds\n", n_sets, set_processing_time.tv_usec);
...
int store_record(struct storage_record *r)
{
    ...
    fprintf(client_time_log, "storage_set performed in %ld microseconds\n", (end_time.tv_sec - start_time.tv_sec)*1000000L + (end_time.tv_usec - start_time.tv_usec));
